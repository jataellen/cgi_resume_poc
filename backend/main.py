...
# Progress tracking helper (replaces Streamlit progress bar)
...
# Null logger (replaces Streamlit logging)
class NullLogger:
...
async def process_resume_async(session_id: str):
    ...
    try:
        ...
        # Initialize logging (no Streamlit needed)
        initialize_log_box(NullLogger())
        ...
        await loop.run_in_executor(
            executor,
            resume_stream,
            None,  # No Streamlit object needed
            progress_tracker,
            base_progress,
