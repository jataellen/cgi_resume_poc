...
if submitted and uploaded_files:
    ...
    for i, uploaded_file in enumerate(uploaded_files):
        ...
        try:
            # Process the PDF
            resume_stream(st, progress_bar, base_progress, file_progress_weight, temp_file_path)
            ...
            new_file_name = os.path.splitext(original_file_name)[0] + f"_updated_{file_id}.docx"
...
if st.session_state.processed_files:
    ...
    # Download All button
    successful_files = [file for file in st.session_state.processed_files 
                        if file["output_path"] and os.path.exists(file["output_path"])]
    ...
    if successful_files:
        ...
        with zipfile.ZipFile(zip_buffer, 'w') as zip_file:
            for file in successful_files:
                zip_file.write(file["output_path"], os.path.basename(file["output_path"]))
