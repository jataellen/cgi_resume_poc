...
import streamlit as st
import streamlit as st 
from pages import director, senior, partner, new_partner, audits, general
...
page = st.sidebar.radio("Go to", ["Home", "Director", "Senior", "Partner", "New Partner", "Audits", "General"])
